...
<section class="text-gray-600 body-font">
    ...
    <div class="py-6 sm:py-8 lg:py-12">
        <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">You have requested for({{ $bookingRequests->total() }}) destination.</h2>
    </div>
    {{-- /Counter Requested --}}
                ...
                <div class="h-full bg-white border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center flex-wrap ">
                            <a href="{{ route('showBookingRequestDetails', ['id' => $bookingRequest->id])}}" class="text-yellow-500 inline-flex items-center md:mb-2 lg:mb-0">Show Response
                            ...
                            <span class="text-gray-400 inline-flex items-center leading-none text-sm">
                                ...
                                </svg>{{ $bookingRequest->contract_count }}
                            </span>
                        </div>
                    </div>
                </div>
...
@else
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <p class="mb-2 text-center font-semibold text-indigo-500 md:mb-3 lg:text-lg">Hello, {{ auth()->user()->name }}</p>
            <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Sorry..!</h2>
            <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">You have not any Ride Request available. But you can request for ride as long drive.</p>
        </div>
    </div>
    {{-- /Notice not found --}}
